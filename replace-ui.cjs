...
const target = \`<div className="w-full bg-white/5 rounded-full h-1.5 overflow-hidden shadow-inner border border-white/10 mb-4">
...
const replacement = \`<div className="w-full bg-white/5 rounded-full h-1.5 overflow-hidden shadow-inner border border-white/10 mb-4">
                            <div className="bg-blue-500 h-1.5 rounded-full transition-all duration-300 ease-out" style={{ width: \\\`\\\${setupProgressNum}%\\\` }}></div>
                          </div>
                             ...
                             <div className="mb-4 bg-purple-900/20 rounded p-2 border border-purple-500/20">
                               <div className="flex justify-between items-center mb-1.5">
                                 <div className="flex items-center space-x-2">
                                    <svg className="w-3.5 h-3.5 text-purple-400 animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>
